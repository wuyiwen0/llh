                            ...
                            <li>
                              <div class="item-content">
                                <div class="item-inner">
                                  ...
                                  <div class="item-input">
                                    <input type="text" name="address" placeholder="请选择收货地址" value="<?php echo ($address["province"]); echo ($address["city"]); echo ($address["area"]); echo ($address["community"]); echo ($address["address"]); ?>" class="fourteenFont"> 
                                  </div>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $("#othersbuy").click(function(){
          $('form').attr('action',"<?php echo U('Home/Menu/othersbuy');?>");
        });
        $("#ownbuy").click(function(){
          $('form').attr('action',"<?php echo U('Home/Menu/ownbuy');?>");
        });
      });
