  ...
  <body>
    ...
    <div class="views">
      ...
      <div class="view view-main">
        <!-- Top Navbar-->
        <div class="navbar navCss textCenter">
          <div class="navbar-inner textCenter">
            <!-- We have home navbar without left link-->
            <div class="center sliding">直播间</div>
            <div class="right">
              <!-- Right link contains only icon - additional "icon-only" class--><a href="/github/Wplus/ThinkWplus/index.php/Home/Video/start" class="link icon-only open-panel external">  <i class="icon fa fa-plus whiteColor"></i></a>
            </div>
          </div>
        </div>
        ...
        <div class="pages navbar-through toolbar-through">
          ...
          <div data-page="index" class="page">
            ...
            <div class="page-content">
                    <div class="row rowCss">   <!-- 栅格直播列表 -->
                        <div class="col-50 cardDis ">
                             <div class="card cardDis">
                                  <div class="card-content">
                                      <div>
                                        <a href="/github/Wplus/ThinkWplus/index.php/Home/Video/content" class="external"><img src="/github/Wplus/ThinkWplus/Public/front/images/video.jpg" width="100%"></a>
                                      </div>  
                                      <div class="cardCss">
                                                <p><a href="#" class="redColor">#中餐#</a>养养猫，做做菜</p>
                                                <p><a href="#" class="greyColor">茶之韵</a><a href="#" class="textRight greyColor floatRight"><i class="icon fa fa-eye"></i>&nbsp;519</a></p>
                                          </a>  
                                      </div>
                                  </div>
                              </div>
        ...
        <!-- Bottom Toolbar-->
          <div class="toolbar textCenter">
            <div class="toolbar-inner">
              ...
              <a href="/github/Wplus/ThinkWplus/index.php/Home/Video/lists" class="external tab-link redColor">
