		...
		<form action="/github/Wplus/ThinkWplus/index.php/Admin/Admin/doEdit" method="post" name="myform" enctype="multipart/form-data">  
		  <div class="col-md-12" style="padding-top:1%">
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-sm-8">
		            <input type="text" name="realname" class="form-control" placeholder="请输入您的真实姓名" value="<?php echo ($adminUsers["realname"]); ?>"> <span class="help-block m-b-none"></span>
		        </div>
		    </div>
		    <div class="form-group">
		  ...
		  <div class="col-md-12" style="padding-bottom:2em">
		    <div class="form-group">
		        ...
		        <div class="col-sm-8">
		            <input type="text" name="position" class="form-control" placeholder="请输入您的职位" value="<?php echo ($adminUsers["position"]); ?>"> <span class="help-block m-b-none"></span>
		        </div>
		    </div>
		    <div class="form-group">
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-sm-8">
		            <input type="text" name="email" class="form-control" placeholder="111111111@qq.com" value="<?php echo ($adminUsers["email"]); ?>"> <span class="help-block m-b-none"></span>
		        </div>
		    </div>
		    <div class="form-group">
                <label class="col-sm-3 control-label">出生日期：</label>
                <div class="col-sm-8">
                    <input class="form-control layer-date" placeholder="YYYY-MM-DD" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})" value="<?php echo ($adminUsers["birth"]); ?>" name="birth">
