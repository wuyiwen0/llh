...
<body class="gray-bg">
                    ...
                    <?php if(is_array($recipe)): $i = 0; $__LIST__ = $recipe;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="panel panel-default" id=<?php echo ($vo["id"]); ?>>
                        <div class="panel-heading ibox-title">
                            ...
                            <div class="ibox-tools">
                                ...
                                <a class="edit-link" href="/github/Wplus/ThinkWplus/index.php/Admin/Recipe/edit/id/<?php echo ($vo["id"]); ?>">
                                    <i class="fa fa-wrench"></i>
                                </a>
                                <a class="close-link" href="/github/Wplus/ThinkWplus/index.php/Admin/Recipe/del/id/<?php echo ($vo["id"]); ?>">
 ...
 for($i=0;$i<count($vo['foodname']);$i++){ echo "<tr>". "<td>".$vo['foodname'][$i]."</td>". "<td>".$vo['foodnum'][$i]."</td>". "</tr>"; } ?>
                                ...
                                <div class="menuProcedure row">
                                    ...
                                    <?php
 for($i = 0; $i<count($vo['step']); $i++){ $step = $i + 1; echo "<div class='col-sm-2'></div>". "<div class='col-sm-10'>". "<div class='col-sm-2 steps'>".$step.".</div>". "<div class='col-sm-8 paddingTop'>". "<p>".$vo['step'][$i]."</p>". "<div>". "<img src='".$vo['img'][$i]."' alt=''>". "</div>". "</div>". "</div>"; } ?>
