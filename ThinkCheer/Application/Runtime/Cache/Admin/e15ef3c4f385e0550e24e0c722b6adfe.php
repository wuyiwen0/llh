...
<body>
    <!-- 图片管理 -->
    <form action="/github/Wplus/ThinkWplus/index.php/Admin/Work/videoBatchDelete" method="post">
    <div class="row tab-pane" style="margin-top:1%;">
        <div class="container">
            ...
            <?php if(is_array($video)): $i = 0; $__LIST__ = $video;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vl): $mod = ($i % 2 );++$i;?><div class="" style="float:left; padding-top:1%;">
                <div style="margin-left: 10px;">
                    <div>
                        <label><input type="checkbox" name="id[]" id="userCheckbox" value="<?php echo ($vl["id"]); ?>"></label>
                        <a href="/github/Wplus/ThinkWplus/index.php/Admin/Work/video/id/<?php echo ($vl["id"]); ?>"><img src="<?php echo ($vl["path"]); ?>" width="200px"/></a>
                    </div>
                    <div class="" style="text-align: center; padding-top:1%;">
                        <button type="button " class="btn btn-default">
                            <a href="/github/Wplus/ThinkWplus/index.php/Admin/Work/videoDelete/id/<?php echo ($vl["id"]); ?>" style="color:">删除</a>     
                        </button>
                    </div>
                </div>
